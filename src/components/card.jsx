function Card({ location }) {
  return (
    <div
      id="card"
      className="flex flex-col items-center gap-4 p-6 px-4 w-full max-w-md mx-auto rounded-2xl border-4 border-white bg-green-600 text-white text-center"
    >
      ...
      <div className="w-full">
        <h1 className="font-bold bg-green-700 py-2 px-4 rounded-t-md">Type of location</h1>
        <div className="bg-green-800 py-2 px-4 rounded-b-md">
      ...
      <div className="w-full">
        <p className="font-bold bg-green-700 py-2 px-4 rounded-t-md">Dimension</p>
        <div className="bg-green-800 py-2 px-4 rounded-b-md">
